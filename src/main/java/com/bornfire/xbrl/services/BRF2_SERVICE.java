...
public class BRF2_SERVICE {
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRF_BHARATH_02_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRF_BHARATH_02_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRF002View(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			List<BRF_BHARATH_02_ENTITY> T1Master = new ArrayList<BRF_BHARATH_02_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRF_BHARATH_02_ENTITY a where a.report_date = ?1 ", BRF_BHARATH_02_ENTITY.class)
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BRF002.jrxml");
					}
